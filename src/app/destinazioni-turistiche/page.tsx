...
export const metadata: Metadata = {
  ...
  description: "Scopri come raggiungere Pompei, Sorrento, Ercolano e altre meraviglie della Campania da Napoli con la Circumvesuviana. Orari, prezzi e consigli utili per turisti.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Pompei, Sorrento, Ercolano: scopri come raggiungerle facilmente da Napoli con la Circumvesuviana. Guida completa per turisti.",
    images: [
      {
  ...
  const destinazioni = [
    {
      ...
      descrizione: "Il sito archeologico più famoso del mondo. I resti dell&apos;antica città romana sepolta dal Vesuvio nel 79 d.C.",
      attrazioni: ["Casa del Fauno", "Teatro Grande", "Anfiteatro", "Villa dei Misteri", "Lupanare"],
      consigli: [
    ...
    },
    {
      ...
      frequenza: "Ogni 30 minuti",
      descrizione: "Perla della Penisola Sorrentina, famosa per i limoni, il limoncello e le viste mozzafiato sul Golfo di Napoli.",
      attrazioni: ["Centro storico", "Marina Grande", "Villa Comunale", "Museo Correale", "Chiostro di San Francesco"],
      consigli: [
    ...
    },
    {
      ...
      descrizione: "Sito archeologico meglio conservato di Pompei, con strutture in legno e mosaici intatti.",
      attrazioni: ["Casa dei Cervi", "Terme", "Casa del Rilievo di Telefo", "Villa dei Papiri", "Teatro"],
      consigli: [
    ...
    },
    {
      ...
      durata: "50 minuti",
      frequenza: "Ogni 30 minuti",
      descrizione: "Borgo marinaro con splendide spiagge e il famoso &apos;cuoppo&apos; di pizza fritta.",
      attrazioni: ["Centro storico", "Spiaggia di Marina di Vico", "Chiesa dell&apos;Annunziata", "Castello Giusso"],
      consigli: [
    ...
    },
    {
      ...
      durata: "40 minuti",
      frequenza: "Ogni 30 minuti",
      descrizione: "Città termale con spiagge e il porto per Capri. Punto di partenza della funivia del Monte Faito.",
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-red-50/20">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto mb-12 text-center">
          Scopri le meraviglie della Campania facilmente raggiungibili da Napoli con i treni 
          della Circumvesuviana. Dai siti archeologici di fama mondiale alle perle della costiera.
        </p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-12">
          ...
          <div className="prose max-w-none">
            <p>
              ...
              destinazioni turistiche più famose della provincia di Napoli. Economica, frequente 
              e ben collegata, ti permette di raggiungere siti archeologici patrimonio dell&apos;UNESCO, 
              borghi marinari incantevoli e paesaggi mozzafiato.
            </p>
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-blue-50 p-4 rounded-md">
                <h3 className="font-semibold text-blue-800">Economico</h3>
                <p className="text-sm">Biglietti da €2,10 a €3,60 per le principali destinazioni</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-md">
              ...
              <div className="p-6">
                ...
                <div className="bg-gray-50 p-3 rounded-md mb-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-500">Costo biglietto:</span>
                      <div className="font-semibold text-green-600">{dest.biglietto}</div>
                    </div>
                    <div>
        ...
        <div className="text-center bg-gradient-to-r from-blue-100 to-red-100 py-8 px-4 rounded-lg">
          ...
          <Link href="/" className="inline-block bg-gradient-to-r from-blue-600 to-red-600 hover:from-blue-700 hover:to-red-700 text-white font-semibold py-3 px-8 rounded-lg transition-all">
